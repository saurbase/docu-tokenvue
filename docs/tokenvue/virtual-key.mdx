---
title: Virtual Keys
description: Create application-facing gateway keys that route traffic through TokenVue without exposing provider credentials.
sidebar_position: 2
---
...
![Virtual Key Configuration](/img/docs/vk-2.png)
